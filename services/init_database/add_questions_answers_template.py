...
В ответ пришлите фото таблички и напишите, кто жил в этом доме.""",
        ...
        self.answers_list = [
            {"text": "Евгений", "is_correct": False, "question_id": 1},
            {"text": "Арсений", "is_correct": True, "question_id": 1},
            {"text": "Семён", "is_correct": False, "question_id": 1},
            {"text": "Христиан", "is_correct": False, "question_id": 1},
            {"text": "1740", "is_correct": True, "question_id": 2},
            {"text": "перловка", "is_correct": False, "question_id": 3},
            {"text": "Америка Италия Россия", "is_correct": True, "question_id": 4},
            {"text": "Комендант", "is_correct": True, "question_id": 5},
        ]
        self.template_list = [
            {
                "name": "ППК команда",
    ...
    @print_message(
        "Start add QuestionsAnswerTemplate", "Complete add QuestionsAnswerTemplate\n"
    )
