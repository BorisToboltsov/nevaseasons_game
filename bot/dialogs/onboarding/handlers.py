...
async def quantity_yes_handler(
    ...
    bot_name = dialog_manager.middleware_data.get(
        "event_update"
    ...
    for link in link_list:
        link_game = LinkGame(link=link, game_session_id=game_session.id)
