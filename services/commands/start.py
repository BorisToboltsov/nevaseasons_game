...
from view.onboarding import send_phone, game_is_finished, invalid_link, participant_game_exist, create_participant_game, \
    command_registration, create_participant_game_full, command_registration_full
    ...
    async def start(self):
        ...
        if utm_tag.utm_tag:
            ...
            try:
                ...
                link_game = db_link_game.get_link_game_by_link(link=link, session=self.session)
            ...
            try:
                ...
                participant = db_participant.get_user_by_telegram(session=self.session,
            ...
            participant_game_is_exist = db_participant_game.get_participant_game_by_gs_p(session=self.session,
            ...
            if game_session.is_finished:
                ...
                if all_participant_game:
                    for participant_game in all_participant_game:
                        ...
                        if participant_game.command_name.name == command_name:
                            ...
                            participant_game = ParticipantGame(participant_id=participant.id,
                ...
                if len(all_participant_game) == game_session.number_participants:
                    ...
                    await command_registration(self.message,
                                               game_session.user.telegram_id,
                                               command_name.name,
